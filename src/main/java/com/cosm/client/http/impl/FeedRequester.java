 ...
 * 
 */
public class FeedRequester implements FeedResource
{
	...
	{
		Response<Feed> response = requestHandler.doRequest(HttpMethod.POST, getResourcesPath(), toCreate);
	...
	{
		Response<Feed> response = requestHandler.doRequest(HttpMethod.GET, getResourcePath(feedId));
			...
			ParseToObjectException
	{
		...
		Response<Feed> response = requestHandler.doRequest(HttpMethod.GET, getResourcePath(feedId), params);
	...
	{
		Response<Feed> response = requestHandler.doRequest(HttpMethod.GET, getResourcesPath(), filterParam);
		return response.getBodyAsObjects(Feed.class);
	}
	...
	{
		Response<Feed> response = requestHandler.doRequest(HttpMethod.PUT, getResourcePath(toUpdate.getId()), toUpdate);
		return toUpdate;
	}
	...
	{
		requestHandler.doRequest(HttpMethod.DELETE, getResourcePath(feedId));
	}
