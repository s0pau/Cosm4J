 ...
 * 
 */
public class DatastreamRequester implements DatastreamResource
{
	private final DefaultRequestHandler requestHandler = DefaultRequestHandler.make();

	/* (non-Javadoc)
	 * @see com.cosm.client.http.DatastreamResource#create(int, com.cosm.client.model.Datastream)
	 */
	@Override
	public Datastream create(int feedId, Datastream toCreate) throws HttpException
	{
		requestHandler.doRequest(HttpMethod.POST, getResourcesPath(feedId), toCreate);
		return toCreate;
	}
	...
	{
		Response<Datastream> response = requestHandler.doRequest(HttpMethod.GET, getResourcePath(feedId, dataStreamId));
		return response.getBodyAsObject(Datastream.class);
	}

	/* (non-Javadoc)
	 * @see com.cosm.client.http.DatastreamResource#update(int, com.cosm.client.model.Datastream)
	 */
	@Override
	public Datastream update(int feedId, Datastream toUpdate) throws HttpException
	{
		requestHandler.doRequest(HttpMethod.PUT, getResourcePath(feedId, toUpdate.getId()), toUpdate);
		return toUpdate;
	}

	/* (non-Javadoc)
	 * @see com.cosm.client.http.DatastreamResource#delete(int, java.lang.String)
	 */
	@Override
	public void delete(int feedId, String dataStreamId) throws HttpException
	{
		requestHandler.doRequest(HttpMethod.DELETE, getResourcePath(feedId, dataStreamId));
	}
